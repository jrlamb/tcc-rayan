    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            onSelect: function (files) {
			   ...
			   $(".ajax-upload-dragdrop").fadeOut(350, function(){
				   $("#startUpload").fadeIn(350);
				});
				return true;
            },
            ...
            onCancel: function (files, pd) {
				$("#startUpload").attr('disabled');
				$("#startUpload").fadeOut(350, function(){
					$(".ajax-upload-dragdrop").fadeIn(350)
				}); },
